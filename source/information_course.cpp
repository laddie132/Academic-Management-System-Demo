...
void Information_course::showInfo()
{
    if(m_course){
        ...
        ui->comboBox_teacher->addItem(QString::fromStdString(m_course->getTeacher()->getID()));
    }
    else{
        ui->comboBox_teacher->clear();
...
void Information_course::on_update_btn_clicked()
{
    ...
    QString teacher_id = ui->comboBox_teacher->currentText();
    ...
    QMessageBox::warning(this, QString::fromLocal8Bit("提示"), QString::fromLocal8Bit("无教师信息"));
}
